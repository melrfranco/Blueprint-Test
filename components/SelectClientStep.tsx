...
const SelectClientStep: React.FC<SelectClientStepProps> = ({ clients: propClients, onSelect, onBack }) => {
  ...
  // FIX: Include Square synced clients in the selector
  const clients = useMemo(() => {
    ...
    // Merge propClients with squareSynced
  ...
  const filteredClients = useMemo(() => {
    return clients.filter(c => {
      ...
      // Filter Rule: INCLUDE a client if they have role 'client' 
      // AND (has square_id OR is source 'square' OR is sample)
