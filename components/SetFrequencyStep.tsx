    ...
    <div className="flex flex-col h-full p-4 pb-12">
      <div className="text-center p-4">
        <div className="relative w-full h-2 bg-gray-200 mb-4 rounded-full">
            <div className="absolute top-0 left-0 h-2 bg-brand-pink rounded-full" style={{width: '66%'}}></div>
        </div>
        <h1 className="text-2xl font-bold text-brand-blue">Service Frequency</h1>
            ...
            <div className="flex items-center space-x-2">
                <span className="font-medium text-gray-700">Every</span>
                 <input 
                    ...
                    className="w-20 p-2 border border-gray-300 rounded text-center font-bold text-lg"
                    placeholder="Wks"
                />
      ...
      <div className="p-4 mt-auto space-y-2">
        <button
          ...
          className="w-full bg-brand-teal text-white font-bold py-3 px-4 rounded-full shadow-lg transition-transform transform hover:scale-105 disabled:bg-gray-300 disabled:cursor-not-allowed"
        >
